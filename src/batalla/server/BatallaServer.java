...
public class BatallaServer {
    private static final int SERVER_PORT = 8810;

    private static final int HTTP_PORT = 8811;

    private static final int JMX_PORT = 8812;

    private static final int RMI_PORT = 8813;

    private static Logger log = LoggerFactory.getLogger(BatallaServer.class);
    ...
    public static void main(String[] args) throws Throwable {
        ...
        BatallaSessionHandler server = new BatallaSessionHandler();
        ...
        ObjectName bean = new ObjectName(
                "BatallaServer:type=BatallaServiceManager");
